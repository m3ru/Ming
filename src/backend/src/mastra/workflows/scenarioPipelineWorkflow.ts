...
export const ScenarioPipelineOutputSchema = z.object({
  ...
  prompts: z.string().describe('Generated prompts for Bill character'),
...
const createScenario = createStep({
  id: 'createScenario',
  description: 'Generate a conflict management scenario with Bill based on user analysis',
  ...
  execute: async ({ inputData, runtimeContext }) => {
    ...
    const messages = [
      'Create a workplace conflict scenario with Bill based on this user analysis: ' + analysis,
...
const createPrompts = createStep({
  id: 'createPrompts',
  description: 'Generate LLM prompts for Bill character based on scenario and analysis',
  ...
  execute: async ({ inputData, runtimeContext }) => {
    ...
    const messages = [
      'Create LLM prompts for Bill character based on this scenario and user analysis:',
      'SCENARIO: ' + scenario,
...
## LLM Prompts for Bill Character
${prompts}
...
*This scenario package was generated by analyzing your communication patterns and creating a targeted practice environment for conflict resolution with Bill.*
    `.trim();
